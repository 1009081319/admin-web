...
<head>
    ...
    <!-- Theme style -->
    <link rel="stylesheet" href="/static/dist/adminLTE.min.css">
    <!-- Skin -->
    <link rel="stylesheet" href="/static/dist/_all-skins.min.css">
    <!-- select2 -->
    ...
    <!-- AdminLTE App -->
    <script src="/static/dist/adminlte.min.js"></script>
    <!-- AdminLTE for demo purposes -->
    <script src="/static/dist/demo.js"></script>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <span class="hidden-xs"><shiro:principal property="loginName"/></span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- User image -->
                            <li class="user-header">
                                <img src="/static/image/user2-160x160.jpg" class="img-circle" alt="User Image">
                                <p>
                                    <shiro:principal property="loginName"/> - Web Developer
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="/mallOrder/list"><i class="fa fa-circle-o"></i> 订单列表</a></li>
                        <li><a href="/policyManage/list"><i class="fa fa-circle-o"></i> 保单列表</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="/userManage/list"><i class="fa fa-circle-o"></i> 用户管理</a></li>
                        <li><a href="/roleManage/list"><i class="fa fa-circle-o"></i> 角色管理</a></li>
                        <li><a href="/permissionManage/list"><i class="fa fa-circle-o"></i> 权限管理</a></li>
                        <li><a href="/dictManage/list"><i class="fa fa-circle-o"></i> 字典管理</a></li>
                    </ul>
                </li>
    ...
    $(function () {
        ...
        for(var i=0 ; i<lis.length ; i++){
            ...
            if(href==path){
                ...
                $(li).parents(".treeview").addClass("active menu-open").siblings().removeClass("active");
            }
        }
    });
